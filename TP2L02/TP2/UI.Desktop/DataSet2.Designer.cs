...
namespace UI.Desktop {
    ...
    public partial class DataSet2 : global::System.Data.DataSet {
        ...
        public partial class usuariosDataTable : global::System.Data.TypedTableBase<usuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public usuariosRow AddusuariosRow(string nombre_usuario, string clave, bool habilitado, string nombre, string apellido, string email, string tipo_usuario, string legajo, System.DateTime fecha_nac, string telefono, string direccion) {
...
namespace UI.Desktop.DataSet2TableAdapters {
    ...
    public partial class usuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [usuarios] WHERE (([id_usuario] = @Original_id_usuario) AND ([nombre_usuario] = @Original_nombre_usuario) AND ([clave] = @Original_clave) AND ([habilitado] = @Original_habilitado) AND ([nombre] = @Original_nombre) AND ([apellido] = @Original_apellido) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_tipo_usuario = 1 AND [tipo_usuario] IS NULL) OR ([tipo_usuario] = @Original_tipo_usuario)) AND ((@IsNull_legajo = 1 AND [legajo] IS NULL) OR ([legajo] = @Original_legajo)) AND ((@IsNull_fecha_nac = 1 AND [fecha_nac] IS NULL) OR ([fecha_nac] = @Original_fecha_nac)) AND ((@IsNull_telefono = 1 AND [telefono] IS NULL) OR ([telefono] = @Original_telefono)) AND ((@IsNull_direccion = 1 AND [direccion] IS NULL) OR ([direccion] = @Original_direccion)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [usuarios] ([nombre_usuario], [clave], [habilitado], [nombre], [apellido], [email], [tipo_usuario], [legajo], [fecha_nac], [telefono], [direccion]) VALUES (@nombre_usuario, @clave, @habilitado, @nombre, @apellido, @email, @tipo_usuario, @legajo, @fecha_nac, @telefono, @direccion);
SELECT id_usuario, nombre_usuario, clave, habilitado, nombre, apellido, email, tipo_usuario, legajo, fecha_nac, telefono, direccion FROM usuarios WHERE (id_usuario = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [usuarios] SET [nombre_usuario] = @nombre_usuario, [clave] = @clave, [habilitado] = @habilitado, [nombre] = @nombre, [apellido] = @apellido, [email] = @email, [tipo_usuario] = @tipo_usuario, [legajo] = @legajo, [fecha_nac] = @fecha_nac, [telefono] = @telefono, [direccion] = @direccion WHERE (([id_usuario] = @Original_id_usuario) AND ([nombre_usuario] = @Original_nombre_usuario) AND ([clave] = @Original_clave) AND ([habilitado] = @Original_habilitado) AND ([nombre] = @Original_nombre) AND ([apellido] = @Original_apellido) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_tipo_usuario = 1 AND [tipo_usuario] IS NULL) OR ([tipo_usuario] = @Original_tipo_usuario)) AND ((@IsNull_legajo = 1 AND [legajo] IS NULL) OR ([legajo] = @Original_legajo)) AND ((@IsNull_fecha_nac = 1 AND [fecha_nac] IS NULL) OR ([fecha_nac] = @Original_fecha_nac)) AND ((@IsNull_telefono = 1 AND [telefono] IS NULL) OR ([telefono] = @Original_telefono)) AND ((@IsNull_direccion = 1 AND [direccion] IS NULL) OR ([direccion] = @Original_direccion)));
SELECT id_usuario, nombre_usuario, clave, habilitado, nombre, apellido, email, tipo_usuario, legajo, fecha_nac, telefono, direccion FROM usuarios WHERE (id_usuario = @id_usuario)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id_usuario, nombre_usuario, clave, habilitado, nombre, apellido, email, ti" +
                "po_usuario, legajo, fecha_nac, telefono, direccion\r\nFROM     usuarios";
        ...
        public virtual int Delete(int Original_id_usuario, string Original_nombre_usuario, string Original_clave, bool Original_habilitado, string Original_nombre, string Original_apellido, string Original_email, string Original_tipo_usuario, string Original_legajo, global::System.Nullable<global::System.DateTime> Original_fecha_nac, string Original_telefono, string Original_direccion) {
            ...
            if ((Original_legajo == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[11].Value = ((string)(Original_legajo));
            }
            if ((Original_fecha_nac.HasValue == true)) {
                this.Adapter.DeleteCommand.Parameters[12].Value = ((object)(0));
                this.Adapter.DeleteCommand.Parameters[13].Value = ((System.DateTime)(Original_fecha_nac.Value));
            }
            else {
            ...
            if ((Original_direccion == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[17].Value = ((string)(Original_direccion));
            }
        ...
        public virtual int Insert(string nombre_usuario, string clave, bool habilitado, string nombre, string apellido, string email, string tipo_usuario, string legajo, global::System.Nullable<global::System.DateTime> fecha_nac, string telefono, string direccion) {
        ...
        public virtual int Update(
            ...
            if ((Original_tipo_usuario == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[20].Value = ((string)(Original_tipo_usuario));
            }
            if ((Original_legajo == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[22].Value = ((string)(Original_legajo));
            }
            if ((Original_fecha_nac.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[23].Value = ((object)(0));
                this.Adapter.UpdateCommand.Parameters[24].Value = ((System.DateTime)(Original_fecha_nac.Value));
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[29].Value = ((int)(id_usuario));
        ...
        public virtual int Update(
                    ...
                    string Original_telefono, 
                    string Original_direccion) {
            return this.Update(nombre_usuario, clave, habilitado, nombre, apellido, email, tipo_usuario, legajo, fecha_nac, telefono, direccion, Original_id_usuario, Original_nombre_usuario, Original_clave, Original_habilitado, Original_nombre, Original_apellido, Original_email, Original_tipo_usuario, Original_legajo, Original_fecha_nac, Original_telefono, Original_direccion, Original_id_usuario);
        }
    }
